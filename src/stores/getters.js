export default {
  ...
  getPlannedPosts: (state) => {
    return state.posts.filter((item) => item.status == 'planned')
  },
  getProgressPosts: (state) => {
    return state.posts.filter((item) => item.status == 'progress')
  },
  getLivePosts: (state) => {
    return state.posts.filter((item) => item.status == 'live')
  },
